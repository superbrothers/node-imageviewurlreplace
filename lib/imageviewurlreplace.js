...
ImageViewURLReplace.prototype.init = function () {
};
ImageViewURLReplace.prototype.fetch = function (options, callback) {
  var rule
    , matches
    , uri = options.uri
    , self = this;
...
var ivur = new ImageViewURLReplace();
function imageviewurlreplace(uri, options, callback) {
  ...
  return ivur.fetch(options, callback);
}
imageviewurlreplace.on = function (event, listener) {
  ivur.on(event, listener);
};
module.exports = imageviewurlreplace;
